...
class VideoController extends GetxController {
  ...
  // bool joinedAsAdmin = false;
  // bool joinedAsViwer = false;
  ...
  //         // Get.snackbar("title", "_remoteUid  $remoteUid");
  ...
  //     //     rtcEngine: agoraEngine,
  //     //     canvas: VideoCanvas(uid: 0),
  //     //     connection: RtcConnection(channelId: 'aliTest'),
  //     //   ),
  //     // );
  //     if (_remoteUid != null) {
  //       return AgoraVideoView(
  ...
  // Future<void> joinAsAdmin() async {
  //   //  var token = await getToken(channelName);
  //   var uri = Uri.parse(getAgoraToken);
  ...
  //   //  var uri = ;
  //   await http.post(Uri.parse(applyToken), body: {
  //     // "channelName": userName,
  //     "token": token,
  //     "roomId": Get.arguments["room_id"],
  //     "username": userName,
  ...
  // Future<void> joinAsViewer({String name, String token}) async {
  //   ChannelMediaOptions options;
  //   _isHost = false;
  //   channelName = name;
  //   joinedAsViwer = true;
